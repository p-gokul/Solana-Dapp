  ...
  useEffect(() => {
    const fetchNFTs = async () => {
      ...
      try {
        ...
        const assets = await fetchAllDigitalAssetByOwner(umi, umiPublicKey);
        ...
        setNFTs(nftData);
        console.log("The nft Data is ", nftData);
...
export default useFetchNFTDetails;
